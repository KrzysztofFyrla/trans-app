...
public class EditSemiTrailerController {

    @FXML
    public Button editButtonSemiTrailer;
    @FXML
    ...
    private void validation(){
        this.editButtonSemiTrailer.disableProperty().bind(this.markAddSemiTrailer.textProperty().isEmpty()
    ...
    public void editSemiTrailerOnAction() {
        ...
        try{
            ...
            if(markAddSemiTrailer.getText().matches(regex) && modelAddSemiTrailer.getText().matches(regex)
                ...
                if(permissibleMassAddSemiTrailer.getText().matches(regexNumber) && massAddSemiTrailer.getText().matches(regexNumber)
                    ...
                    DialogUtils.informationDialogEdit();
    ...
    public SemiTrailerModel getSemiTrailerModel(){
        return semiTrailerModel;
    }
}
